...
def get_parser():
    ...
    parser.add_argument(
        '-co', '--config-object', help='configure from object', metavar='CONFIG_OBJECT', dest='conf_obj',
        required=False, type=str, nargs=1)
    parser.add_argument(
        '-cf', '--config-file', help='import local config file', metavar='CONFIG_FILE', dest='conf_file',
        required=False, type=str, nargs=1)
    parser.add_argument(
